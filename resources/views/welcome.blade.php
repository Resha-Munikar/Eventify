...
<section class="relative w-full bg-[#d9d4f7] h-[80vh] overflow-hidden">
  <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 md:px-12 py-28">
    ...
    <div class="max-w-lg text-center md:text-left mb-10 md:mb-0 z-10 relative">
      ...
      <a href="{{ route('register') }}" class="bg-[#8D85EC] text-white px-6 py-3 rounded-lg text-lg font-semibold hover:opacity-90 transition">Get Started</a>
    </div>
  ...
  <!-- Bottom Wave SVG (matches next section #F9FAFB) -->
  <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] z-0">
    <svg class="w-full h-32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none">
      <path fill="#F9FAFB" fill-opacity="1" d="M0,64L48,80C96,96,192,128,288,160C384,192,480,224,576,213.3C672,203,768,149,864,128C960,107,1056,117,1152,138.7C1248,160,1344,192,1392,208L1440,224L1440,320L0,320Z"></path>
    </svg>
  </div>
</section>
...
<section class="py-12 px-4 max-w-7xl mx-auto">
  ...
  <div class="grid md:grid-cols-3 gap-8 text-center">
    <div class="p-8 bg-[#d9d4f7] rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2">
...
<section class="py-12 px-4 bg-gray-50 max-w-7xl mx-auto relative ">
  <h2 class="text-3xl font-bold mb-9 text-center text-gray-800">Upcoming Events</h2>
  ...
  <div class="relative">
    ...
    <div id="upcoming-container" class="flex space-x-6 overflow-x-auto scrollbar-hide snap-x snap-mandatory py-4">
      <!-- Card 1 -->
      <div class="flex-shrink-0 w-[calc(33.333%-16px)] bg-[#E6E4FF] border border-[#8d85ec] rounded-lg shadow-sm  snap-start">
        <a href="#">
  ...
  <div class="flex-shrink-0 w-[calc(33.333%-16px)] bg-[#E6E4FF] border border-[#8d85ec] rounded-lg shadow-sm snap-start">
    ...
    <div class="p-5">
      <a href="#"><h5 class="mb-2 text-2xl font-bold tracking-tight text-black">Birthday Party</h5></a>
      <p class="mb-3 font-normal text-black">Celebrate a special birthday with fun, laughter, and unforgettable memories with friends and family.</p>
      <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#8d85ec] rounded-lg hover:bg-[#746fd6] transition">
        Read more
        <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
  ...
  <div class="flex-shrink-0 w-[calc(33.333%-16px)] bg-[#E6E4FF] border border-[#8d85ec] rounded-lg shadow-sm snap-start">
    ...
    <div class="p-5">
      <a href="#"><h5 class="mb-2 text-2xl font-bold tracking-tight text-black">Concert</h5></a>
      <p class="mb-3 font-normal text-black">Experience live music like never before with amazing performances from top artists.</p>
      <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#8d85ec] rounded-lg hover:bg-[#746fd6] transition">
        Read more
        <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
...
<!-- Why Choose Us -->
<section class="relative py-20 px-4 bg-gradient-to-r from-[#d9d4f7] via-white to-[#d9d4f7] max-w-7xl mx-auto rounded-xl shadow-lg">
...
<section class="py-16 px-4 bg-gray-50 max-w-7xl mx-auto relative">
  ...
  <div class="relative">
    ...
    <div id="testimonial-container" class="flex space-x-6 overflow-x-auto scrollbar-hide snap-x snap-mandatory py-4">
     ...
     <!-- Card 1 -->
      <div class="flex-shrink-0 w-[calc(25%-18px)] p-6 bg-[#d9d4f7] text-white rounded-xl shadow-lg 
            flex flex-col items-center text-center 
            transition-all duration-300 ease-in-out 
            hover:scale-105 hover:-translate-y-2 hover:shadow-2xl hover:bg-[#9a8ff0] snap-start">
