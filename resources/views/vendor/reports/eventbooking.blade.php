...
@section('title', 'Event Booking Report')
@php 
$noNavbar = true;
$noFooter = true; 
@endphp
...
<div class="max-w-7xl mx-auto mt-10 ml-0 sm:ml-72 mr-4 sm:mr-10 p-4">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-100 dark:border-gray-700">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div>
                <h2 class="text-3xl font-bold text-[#8d85ec]">Event Booking Report</h2>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Detailed revenue, ticket tiers breakdown, and attendee summaries.</p>
            </div>
        ...
        <!-- Date Filter Form -->
        <form method="GET" action="{{ route('vendor.reports.eventbooking') }}" class="mb-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl flex flex-wrap items-end gap-4">
            <div>
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('vendor.reports.eventbooking') }}" class="px-4 py-2 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 text-gray-700 dark:text-gray-200 rounded-lg text-xs font-semibold transition">
                    Reset
                </a>
            </div>
        </form>
            ...
            <table class="w-full text-sm text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700 text-gray-800 dark:text-gray-200">
                    ...
                    <tr class="hover:bg-purple-50/50 dark:hover:bg-gray-700/50 transition">
                        ...
                        <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">{{ $booking->user->name ?? 'Guest User' }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="8" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">No event bookings found for the selected period.</td>
                    </tr>
                    @endforelse
                </tbody>
