...
<div class="bg-[#faf9ff] dark:bg-gray-950 text-gray-900 dark:text-gray-100 min-h-screen font-sans overflow-x-hidden">
    ...
    <section class="max-w-4xl mx-auto px-5 sm:px-6 lg:px-12 py-14 sm:py-20">
        ...
        <div class="text-center mb-10 sm:mb-12">
            ...
            <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300 mt-3">
                Everything you need to know about Eventify.
            </p>
        ...
        @php
            $faqs = [
                [
                    ...
                    'answer' => 'Eventify is a two-sided event platform that connects event organizers and attendees. Attendees can discover events while organizers can create events, configure ticket tiers, and manage bookings.'
                ],
                [
                    'icon' => 'solar:magnifer-bold',
                    'question' => 'How can I discover an event?',
                    'answer' => 'You can browse events on the Events page using categories, search, location, and other available filters.'
                ],
                [
                    'icon' => 'solar:card-send-bold',
                    'question' => 'How do I book a ticket?',
                    'answer' => 'Open an event, view its details, select your preferred ticket type and quantity, and continue through the booking process.'
                ],
                [
                    'icon' => 'solar:bookmark-bold',
                    'question' => 'Can I save events for later?',
                    'answer' => 'Yes. Use the save or heart icon on an event card to add the event to your saved events.'
                ],
                [
                    'icon' => 'solar:shop-2-bold',
                    'question' => 'How can I list my event?',
                    'answer' => 'Registered event organizers can access the vendor area and create a new event by entering event details, uploading an image, and configuring tickets.'
                ],
                [
                    'icon' => 'solar:user-plus-bold',
                    'question' => 'Who can become an event organizer?',
                    'answer' => 'People or organizations hosting events can register as vendors and use Eventify to publish their events.'
                ],
                [
                    'icon' => 'solar:chart-square-bold',
                    'question' => 'How can vendors manage their events?',
                    'answer' => 'Vendors can use their dashboard to manage event information, tickets, bookings, attendee information, and available reports.'
                ],
            ];
        @endphp
        ...
        <div id="faq-accordion" class="space-y-3">
            ...
            @foreach($faqs as $faq)
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm">
                    ...
                    <button
                        type="button"
                        class="w-full flex justify-between items-center p-4 sm:p-5 font-semibold text-left text-gray-900 dark:text-white hover:text-[#6C5CE7] dark:hover:text-[#a78df0] transition focus:outline-none"
                        aria-expanded="false"
                    >

                        <span class="inline-flex items-center gap-3 pr-4">

                            <span class="w-8 h-8 rounded-xl bg-purple-100 dark:bg-purple-900/50 text-[#8D85EC] dark:text-[#a78df0] flex items-center justify-center shrink-0 text-base">
                                <iconify-icon icon="{{ $faq['icon'] }}"></iconify-icon>
                            </span>
                        ...
                        <svg
                            class="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 shrink-0 transition-transform duration-300"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
                    ...
                    <div class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out bg-[#faf9ff]/60 dark:bg-gray-900/50">

                        <div class="p-4 sm:p-5 pt-1 text-xs sm:text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                            {{ $faq['answer'] }}
                        </div>
