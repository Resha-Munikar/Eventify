...
<div class="max-w-7xl mx-auto mt-10 ml-0 sm:ml-72 mr-4 sm:mr-10 p-4">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-100 dark:border-gray-700">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div>
                <h2 class="text-3xl font-bold text-[#8d85ec]">Activity Log</h2>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Platform-wide activity log of Users, Vendors, and Admins across Eventify.</p>
            </div>
        ...
        <form method="GET" action="{{ route('admin.activityLogs.index') }}" 
              ...
              class="mb-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" 
                               ...
                               class="block w-full border border-gray-300 dark:border-gray-600 rounded-lg p-2.5 text-xs dark:bg-gray-800 dark:text-white pl-8 focus:ring-[#8d85ec] focus:border-[#8d85ec]">
                        <svg class="w-4 h-4 text-gray-400 absolute left-2.5 top-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div>
                    ...
                    <select id="role" 
                            name="role" 
                            class="block w-full border border-gray-300 dark:border-gray-600 rounded-lg p-2.5 text-xs dark:bg-gray-800 dark:text-white focus:ring-[#8d85ec] focus:border-[#8d85ec]">
            ...
            <div class="flex items-center gap-2 justify-end pt-1">
                <button type="submit" 
                        class="bg-[#8D85EC] hover:bg-[#7b76e4] text-white px-5 py-2 rounded-lg text-xs font-semibold transition shadow-sm inline-flex items-center gap-1.5">
                ...
                <a href="{{ route('admin.activityLogs.index') }}" 
                   class="px-4 py-2 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 text-gray-700 dark:text-gray-200 rounded-lg text-xs font-semibold transition">
                    Reset
                </a>
            </div>
        </form>
