<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-6 py-10 overflow-y-auto bg-gray-200 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('chirps.adminIndex') }}" 
                   class="flex items-center p-2 rounded-lg group transition-colors duration-200 ease-in-out
                    ...
                    <svg class="w-5 h-5 text-[#8d85ec] transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
            ...
            <li>
                <a href="{{ route('chirps.user') }}" 
                   class="flex items-center p-2 rounded-lg group transition-colors duration-200 ease-in-out
                    ...
                    <svg class="w-5 h-5 text-[#8d85ec] transition duration-75" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
            ...
            <li>
                <a href="#" 
                   class="flex items-center p-2 rounded-lg group transition-colors duration-200 ease-in-out
                    ...
                    <svg class="w-5 h-5 text-[#8d85ec] transition duration-75" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <!-- Report Dropdown -->
            <li x-data="{ open: {{ request()->routeIs('reports.*') ? 'true' : 'false' }} }" class="relative">
                <button @click="open = !open"
                        class="flex items-center w-full p-2 rounded-lg group transition-colors duration-200 ease-in-out
                               {{ request()->routeIs('reports.*') ? 'bg-gray-300 dark:bg-gray-700 text-[#8d85ec]' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                    <svg class="w-5 h-5 text-[#8d85ec] transition duration-75" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li>
                <form action="{{ route('chirps.adminLogout') }}" method="POST">
                    ...
                    <button type="submit"
                        ...
                        <svg class="w-5 h-5 text-[#8d85ec] transition duration-75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
